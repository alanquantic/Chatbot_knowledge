...
export default function GuiaPage() {
  ...
  const explicarNivel = (nivel: string) => {
    const explicaciones: Record<string, string> = {
      'Todos los niveles': '✨ TODOS LOS NIVELES\n\nEste método es adecuado para:\n\n• Principiantes que están comenzando\n• Practicantes intermedios\n• Usuarios avanzados\n\nNo requiere experiencia previa y puede ser utilizado por cualquier persona, independientemente de su nivel de familiaridad con las enseñanzas de Grabovoi.',
      'Principiante': '🌱 NIVEL PRINCIPIANTE\n\nEste método es ideal para:\n\n• Personas que están comenzando\n• Sin experiencia previa necesaria\n• Ejercicios simples y directos\n• Tiempo de práctica corto (5-10 minutos)\n\nRecomendado como primer método para familiarizarse con las técnicas.',
      'Intermedio': '⭐ NIVEL INTERMEDIO\n\nEste método requiere:\n\n• Experiencia básica con las secuencias\n• Mayor concentración mental\n• Tiempo de práctica medio (10-20 minutos)\n• Comprensión de conceptos fundamentales\n\nRecomendado después de dominar los métodos básicos.',
      'Avanzado': '🚀 NIVEL AVANZADO\n\nEste método requiere:\n\n• Experiencia considerable con las prácticas\n• Alta capacidad de concentración\n• Tiempo de práctica extendido (20+ minutos)\n• Dominio de múltiples técnicas\n\nRecomendado solo para practicantes experimentados.'
    };

    const mensaje = explicaciones[nivel] || `ℹ️ NIVEL: ${nivel}\n\nEste es un indicador del nivel de dificultad o experiencia recomendada para este método o ejercicio.`;
    alert(mensaje);
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-8">
        <div className="container mx-auto max-w-5xl px-4">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4">Guía Práctica</h1>
            <p className="text-muted-foreground text-lg">
              Métodos, ejercicios y recomendaciones para aplicar las enseñanzas de Grigori Grabovoi
            </p>
          </div>
          ...
          <Card className="mb-6 bg-blue-50 dark:bg-blue-950">
            <CardHeader>
              <CardTitle>Cómo Pronunciar las Secuencias</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>Métodos de Aplicación</CardTitle>
              <CardDescription>Diferentes formas de trabajar con las secuencias</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                {/* Métodos Activos */}
                <div>
                  <h3 className="font-bold text-lg mb-4">Métodos Activos</h3>
                ...
                {/* Métodos Pasivos */}
                <div>
                  <h3 className="font-bold text-lg mb-4">Métodos Pasivos</h3>
                  <div className="space-y-4">
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>Ejercicios Básicos para Comenzar</CardTitle>
              <CardDescription>5 ejercicios esenciales paso a paso</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                  ...
                  <Card key={index}>
                    <CardHeader>
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <Badge variant="outline" className="mb-2">Ejercicio {ejercicio?.numero}</Badge>
                          <CardTitle className="text-xl mb-3">{ejercicio?.titulo}</CardTitle>
                          <div className="flex flex-col space-y-1 text-sm text-muted-foreground">
                            <div><strong>Secuencia:</strong> <span className="font-mono text-primary">{ejercicio?.secuencia}</span></div>
                            <div><strong>Duración:</strong> {ejercicio?.duracion}</div>
                            <div><strong>Tiempo:</strong> {ejercicio?.tiempo_recomendado}</div>
                          </div>
                        </div>
                        <Button 
                          variant="outline" 
                      ...
                      {ejercicio?.tip && (
                        <div className="p-3 bg-amber-50 dark:bg-amber-950 rounded-lg">
                          <div className="flex items-start space-x-2">
                            ...
                            <div>
                              <strong className="text-sm text-amber-900 dark:text-amber-100">Tip:</strong>
          ...
          <Card className="mb-6 bg-purple-50 dark:bg-purple-950">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Estado Mental Óptimo: Alegría, Luz y Amor</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
