                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/libros">
                    <Button>
                      ...
                      {t('empty.exploreBooks')}
                    </Button>
                  </Link>
                  <Link href="/secuencias">
                    <Button variant="outline">
                      <Hash className="mr-2 h-4 w-4" />
                      {t('empty.exploreSequences')}
                    </Button>
                  </Link>
                </div>
              </CardContent>
              ...
              {bookFavorites?.length > 0 && (
                <div>
                  <h2 className="text-2xl font-bold mb-4 flex items-center space-x-2">
                    ...
                    <span>{t('sections.books', { count: bookFavorites?.length })}</span>
                  </h2>
              ...
              {sequenceFavorites?.length > 0 && (
                <div>
                  <h2 className="text-2xl font-bold mb-4 flex items-center space-x-2">
                    ...
                    <span>{t('sections.sequences', { count: sequenceFavorites?.length })}</span>
                  </h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
