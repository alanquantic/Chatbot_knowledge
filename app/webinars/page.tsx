      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Cargando webinars...</p>
          </div>
        </main>
        <Footer />
      </div>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-8">
        <div className="container mx-auto max-w-7xl px-4">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4">Webinars y Videos</h1>
            <p className="text-muted-foreground text-lg">
              Colección de 10 webinars de YouTube con enseñanzas clave y ejercicios prácticos
            </p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground">
            Total: {webinars?.length ?? 0} webinars disponibles
          </div>
        </div>
      </main>
      <Footer />
